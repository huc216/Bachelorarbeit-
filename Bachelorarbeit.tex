...
%Für Tabellen (selbst eingefügt)
\usepackage{tabularx}
\usepackage{booktabs} % Wird ebenfalls für die Tabelle benötigt
...
\usepackage{gauss}
\usepackage{tikz}
\usetikzlibrary{decorations.pathmorphing, arrows.meta, patterns, positioning,shapes.geometric,calc}
\usepackage{float}
\usepackage{amssymb}
\usepackage{setspace}
...
\newcommand{\doctitle}{Einführung eines Standards zur Aufbereitung und Auswertung von Messdaten für Schwingfestigkeitsversuche}
%---------------------------------- -------------------------------------
...
\newcommand{\bearbeitungszeitraum}{{<16.03.2026 -- 16.08.2026>}}
...
\begin{document}
    ...
    \include{chapters/title_abstract_content}
    ...
    \include{chapters/Scherzugversuch}


    \include{chapters/Wöhlerversuch}

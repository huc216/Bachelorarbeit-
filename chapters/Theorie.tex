...
Bei einem statischen Zugversuch verformt sich das Bauteil unter der Streckgrenze elastisch und über der Streckgrenze sowohl elastisch als auch plastisch \cite[Seite 8]{Laepple2016}. Unter zyklischer Belastung hingegen treten plastische Verformungen in der Mikrostruktur des Metalls bereits weit unterhalb der Streckgrenze auf. Das Voranschreiten dieser mikrostrukturellen Schädigung ist die sogennante Ermüdung, die schlussendlich zu einem Ermüdungsbruch führen kann.  

Während der Zugversuch also die statische Maximalkraft $F_{\text{max}}$ ermittelt, untersucht der Wöhlerversuch das Versagen des Bauteils bei zyklischer Beanspruchung weit unter dieser Maximalkraft, verursacht durch Materialermüdung \cite[Seite 1-5]{Ermüdungsfestigkeit2007}. 

Wenn nun die innere Kraft auf die beanspruchte Querschnittsfläche bezogen wird, entsteht der Begriff der Spannung \cite[Seite 9-10]{Balke2008}. Der Spannungsbegriff wird in die Normalspannung und die Tangentialspannung, die sich durch die unterschiedliche Krafteinwirkung voneinander abgrenzen, unterteilt. Normalspannungen entstehen durch senkrecht auf die Fläche auftretende Kräfte. Tangentialspannungen hingegen treten immer dann auf, wenn Kräfte in der Schnittebene -- auch Querkräfte $F_Q$ genannt -- vorliegen~\cite[Seite 206]{KabusFestigkeitslehre2023}. Diese elastischen und plastischen Verformungen sind die Auswirkung einer wirkenden Spannung.
Im elastischen Fall bewegt sich das Bauteil nach Entlastung wieder in die Ausgangslage zurück. Im Gegensatz zur plastischen Verformung, bei der eine irreversible Schädigung zurückbleibt, die die Grundlage für die spätere Ermüdung bildet. 
...
Bei dem Wöhlerversuch sind es eben diese Mikrorisse, die schließlich zum Versagen des Bauteils führen. Deshalb wird untersucht, wie viele Lastspiele das Material aushält, bevor die Summe der Mikrorisse zu einer Schädigung des Bauteils führen.
	...
	\subsection{Makroskopische Schwingungskenngrößen}
...
Das Probit-Verfahren erfordert eine Festlegung von mindestens 4 Lasthorizonten. Auf jedem Lasthorizont müssen mindestens 10 Proben geprüft werden, um die Streuung auswerten zu können. Wie in \Figref{fig:probit_verfahren} veranschaulicht muss dabei jeder Lasthorizont mindestens einen Bruch und einen Durchläufer aufweisen.  

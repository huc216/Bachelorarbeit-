...
Am Ende der Zeitfestigkeitsgerade folgt die Knickschwingspielzahl. Diese liegt im Bereich zwischen $5 \cdot 10^4$ und $10^7$ Lastwechseln und repräsentiert den Übergang von der Zeitfestigkeit zur Langzeitfestigkeit.
...
\begin{itemize}
    ...
    \item {Typ II: Gerade mit geringerer Neigung $k^*$}
...
Zu erkennen ist, dass bei Typ II die Spannungsamplitude weiter abfällt, jedoch mit einer geringeren Neigung $k^*$. Im Unterschied dazu verläuft Typ I horizontal ab der Grenzschwingspielzahl $N_G$. 

...
Die Parameter $k$ und $C$ in \Eqref{eq:Zeitfestigkeitsgerade_C} stehen für die Steigung der Zeitfestigkeitsgeraden und für den Lageparameter der Schwingspielzahl $N$ für $\sigma_{\text{a}} = 1$. 
...
Mit den bestimmten Regressionsparametern können nun der Steigungsparameter $k$ und der Lageparameter $C$ der Basquin-Gleichung in \Eqref{eq:reg_C} und \Eqref{eq:reg_k} bestimmt werden: 
...
Für die abschließende Auswertung der Treppenstufenfolge wird nach dem letzten realen Versuch eine fiktive Folgeprobe ergänzt. Nach einem Durchläufer wird diese der nächsthöheren Laststufe und nach einem Bruch der nächstniedrigeren Laststufe zugeordnet~\cite[Seite~60]{DIN50100}.
...
Dabei bezeichnet \(k_2\) den Steigungsparameter der Wöhlerlinie im Langzeitfestigkeitsbereich und beschreibt den weiteren Abfall der Lastamplitude bei Wöhlerlinien des Typs II~\cite[Seite~105]{DIN50100}.

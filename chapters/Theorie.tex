...
Anhand von zwei bekannten Punkten, die innerhalb der Zeitfestigkeitsgerade 
\begin{equation}\label{eq:Neigungsexponent}
    k = - \frac{\lg \left( \frac{N_1}{N_2} \right)}{\lg \left( \frac{\sigma_{\text{A}1}}{\sigma_{\text{A}2}} \right)}
\end{equation}

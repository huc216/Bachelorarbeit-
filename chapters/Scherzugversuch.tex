...
Die Aluminiumproben der ersten Charge sind exemplarisch in \Figref{fig:Zugproben Aluminium} dargestellt.
    ...
    \begin{figure}[H]
        \centering
            \includegraphics[width=0.65\textwidth]{Zugproben_Aluminium}
